// Importa el paquete pg y extraer directamente la clase pool
const { Pool } = require('pg');
// Importa la clase Cursor del paquete pg-cursor
const Cursor = require("pg-cursor");
// Capturar argumentos por la linea de comandos
...
// Instanciar la clase Pool pasandole a su constructor el objeto de configuaracion 
// y almacenando su instancia en una constante
const pool = new Pool(config);

// Funcion asincrona para registrar una nueva cuenta en la base de datos
...
// Función asíncrona para depósito:
...
// Función asíncrona para consultar transacciones en la cuenta:
